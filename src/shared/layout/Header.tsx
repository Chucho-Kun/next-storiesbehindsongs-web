      ...
      <div className="mx-auto flex max-w-6xl items-center justify-between gap-4 px-4 py-3 sm:px-8">
        ...
        <form action="/search" method="GET" role="search" className="flex w-full max-w-sm">
          <input
            ...
            className="w-full rounded-l-sm border border-neutral-700 bg-neutral-900 px-3 py-2 text-sm text-foreground placeholder:text-neutral-500 focus:outline-none focus:ring-1 focus:ring-title"
          />
          <button
            type="submit"
